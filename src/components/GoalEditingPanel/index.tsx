...
const GoalEditingPanel = ({data, setOpenState}:
        ...
        <div onClick={()=> {
            ...
            border-teal-500 shadow-md flex flex-col pb-6 pt-12 px-4 gap-y-4'>
                <div className='flex justify-between'>
                    <p className='text-lg font-semibold font-sans w-full p-2'>{data?.name}</p>
                </div>
                            ...
                            if(v.state){
                                ...
                                return <div className='flex item-center flex-row'>
                                            <div className='pt-1.5'>
                                                ...
                                                className='mr-2 hover:text-green-600 text-black/20 hover:cursor-pointer hover:scale-105 active:scale-100' />
                                            </div>
                ...
                <button className='hover:scale-105 active:scale-100 h-[40px] rounded w-[100px] bg-teal-500'
                        onClick={(e)=>{
                            if(data && steps)

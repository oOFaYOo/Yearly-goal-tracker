...
const GoalCreationPanel = ({state, setNeedUpdate, closeFunction}:
    ...
    return state ? ( <div className='absolute h-[100vh] w-[100vw] flex justify-center items-center'>
            ...
            <form onSubmit={(e)=>{
                ...
                className='styled_scrollbar_hovered w-[35vw] absolute z-20 h-[80vh] border-r-[24px] min-w-[400px] bg-slate-100 rounded
            border-teal-500 shadow-md flex flex-col pb-6 pt-12 px-4 gap-y-4'>
                ...
                }} className='flex grow mr-2 p-2 rounded' type={'text'} placeholder={'Goal...'}/>
                <input name={'year'} className='w-[100px] p-2 rounded' type={'number'} min={1950} defaultValue={new Date().getFullYear()} placeholder={'Year...'}/>
                </div>
                ...
                <div className='flex item-center flex-row'>
                    ...
                    <input className='rounded outline-none p-2 w-full' value={newStep} type={'text'} placeholder={'Step...'}
                                ...
                                <div className='flex item-center flex-row' key={i}>
                                    <div className='pt-1.5'>
                                        <DeleteOutlineIcon onClick={()=>{
                                            ...
                                            className='mr-2 hover:text-rose-500 text-black/20 hover:cursor-pointer hover:scale-105 active:scale-100'/>
                                    </div>
                                    <input required onInvalid={(e)=>{
                                           ...
                                           }} className='rounded outline-none p-2 w-full' onChange={(e)=>{
                                        const newSteps = [...steps];
